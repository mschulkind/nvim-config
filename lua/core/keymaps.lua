...
-- Quick switch to alternate buffer (per-window, like alt-tab)
vim.keymap.set("n", "<leader><leader>", "<C-^>", { silent = true, desc = "Switch to alternate buffer" })
...
-- Load all diagnostics into quickfix list with source info
vim.keymap.set("n", "<leader>d", function()
  vim.diagnostic.setqflist({ open = true })
end, { silent = true, desc = "Load diagnostics into quickfix" })

-- Alias: <leader>e for errors (mnemonic: error instead of diag)
vim.keymap.set("n", "<leader>e", function()
  vim.diagnostic.setqflist({ open = true })
end, { silent = true, desc = "Load errors into quickfix" })
...
-- Gemini keymaps are provided by the plugin spec for marcinjahn/gemini-cli.nvim
-- See: config/nvim/lua/plugins/simple_plugins.lua
